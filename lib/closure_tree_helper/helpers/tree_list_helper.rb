module ClosureTreeHelper
  module TreeListHelper
    ...
    def tree_list(nodes, opts={})
      ...
      rtag = opts[:root_tag].dup
      list = build_tree_list_by_tree_list(nodes, opts[:root_tag], opts)
      list << close_tag(rtag)
      list.join
    end
